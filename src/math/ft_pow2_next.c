...
inline uint8_t	ft_pow2_next8(uint8_t n)
{
	uint32_t j;
	uint32_t i;
...
inline uint16_t	ft_pow2_next16(uint16_t n)
{
	uint32_t j;
	uint32_t i;
...
inline uint32_t	ft_pow2_next32(uint32_t n)
{
	uint32_t j;
	uint32_t i;
...
inline uint64_t	ft_pow2_next64(uint64_t n)
{
	uint64_t j;
	uint64_t i;
...
inline size_t	ft_pow2_next(size_t n)
{
	size_t i;
	size_t j;
