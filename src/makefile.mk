...
LIBFT_OBJ += $(LIBFT_ROOT_DIR)/src/glob/glob_brace.o
LIBFT_OBJ += $(LIBFT_ROOT_DIR)/src/glob/glob_climb_tree.o
LIBFT_OBJ += $(LIBFT_ROOT_DIR)/src/glob/glob_match.o
LIBFT_OBJ += $(LIBFT_ROOT_DIR)/src/glob/glob_util/glob_dir.o
LIBFT_OBJ += $(LIBFT_ROOT_DIR)/src/glob/glob_util/glob_finder.o
LIBFT_OBJ += $(LIBFT_ROOT_DIR)/src/glob/glob_util/glob_is_magic.o
LIBFT_OBJ += $(LIBFT_ROOT_DIR)/src/glob/glob_util/glob_list.o
LIBFT_OBJ += $(LIBFT_ROOT_DIR)/src/glob/glob_util/glob_path.o
LIBFT_OBJ += $(LIBFT_ROOT_DIR)/src/glob/glob_util/glob_sanitize.o
LIBFT_OBJ += $(LIBFT_ROOT_DIR)/src/glob/glob_util/glob_show.o
LIBFT_OBJ += $(LIBFT_ROOT_DIR)/src/glob/globux.o
